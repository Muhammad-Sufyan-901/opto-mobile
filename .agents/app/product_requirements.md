...
2. User sets theme (Dark/High-Contrast default), text size, voice, and haptic — each step has "Skip" and "Replay audio" (single tap), 100% completable via TalkBack/VoiceOver.
...
_This is the agent team's working summary of the full Opto PRD. For exhaustive user stories and acceptance criteria, defer to the canonical PRD document maintained by the product owner._
